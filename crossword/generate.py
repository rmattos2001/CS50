...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        # make a variable that alerts if the review was carried out
        revision_made = False
    ...
    def consistent(self, assignment):
        ...
        # check if value is the correct length
        ...
        # cases checked, no conflicts, can return True
        return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        # sort variables dictionary by number of eliminated values
